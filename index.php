    ...
    <div class="page-wrapper">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="image-wrapper">
                            <div class="image-one"><img class="lazy-image owl-lazy" src="assets/images/resource/image-spacer-for-validation.png" data-src="assets/images/resource/image-11.jpg" alt=""></div>
                            <div class="image-two"><img class="lazy-image owl-lazy" src="assets/images/resource/image-spacer-for-validation.png" data-src="assets/images/resource/image-12.jpg" alt=""></div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="content-box ml-lg-3">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fadeInUp animated active" id="tab-one" role="tabpanel" aria-labelledby="tab-one">
                                    <div class="clearfix">
                                        <div class="image"><img class="lazy-image owl-lazy" src="assets/images/resource/image-spacer-for-validation.png" data-src="assets/images/resource/image-13.jpg" alt=""></div>
                                        <div class="text">
        ...
        <section class="services-section-three">
            <div class="auto-container">
                ...
                <div class="row">
                    <!-- Services Bronze -->
                    <div class="service-block-five col-lg-3">
                        <div class="inner-box">
                            <div style="color:red;"  class="icon"><span class="flaticon-money" ></span><span class="round-shape"></span></div>
                            <h3>Investment Capital</h3>
                            <div class="text">#200,000  - #1,000,000</div>
                            <hr>
                            <h3>Returns On Investment</h3>
                            <div class="text">20%</div>
                            <hr>
                            <h3>Duration</h3>
                            <div class="text">10 Months</div>
                            <hr>
                            <h3>Total</h3>
                    ...
                    <!-- Services Silver -->
                    <div class="service-block-two col-lg-3">
                    <div class="inner-box">
                            <div style="color:#3BB5C4;" class="icon"><span class="flaticon-money"></span> <span class="round-shape"></span></div>
                            <h3>Investment Capital</h3>
                            <div class="text">2 MILLION  - 5 MILLIOM</div>
                            <hr>
                            <h3>Returns On Investment</h3>
                    ...
                    <!-- Services Gold -->
                    <div class="service-block-three col-lg-3">
                    <div class="inner-box">
                            <div style="color:#3BB5C4;" class="icon"><span class="flaticon-money"></span><span class="round-shape"></span></div>
                            <h3>Investment Capital</h3>
                            <div class="text">6 MILLION  - 10 MILLIOM</div>
                            <hr>
                            <h3>Returns On Investment</h3>
                    ...
                    <!-- Services Diamond -->
                    <div class="service-block-four col-lg-3">
                    <div class="inner-box">
                            <div style="color:#3BB5C4;" class="icon"><span class="flaticon-money"></span><span class="round-shape"></span></div>
                            <h3>Investment Capital</h3>
                            <div class="text">11 MILLION  - 20 MILLIOM</div>
                            <hr>
                            <h3>Returns On Investment</h3>
        ...
        <section class="feature-section-two">
            <div class="theme_carousel owl-theme owl-carousel" data-options='{"loop": true, "margin": 0, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 6000, "smartSpeed": 300, "responsive":{ "0" :{ "items": "1" }, "768" :{ "items" : "1" } , "1000":{ "items" : "1" }}}'>
                <!-- Slide Item -->
                <div class="slide-item">
                    <div class="image-layer lazy-image" data-bg="url('assets/images/background/image-12.jpg')"></div>

                    <div class="auto-container">
                        <div class="content-box">
                            <div class="sec-title">
                                <div class="sub-title">Family Matter</div>
                                <h2>Keep On Touch With <br>Us For Update.</h2>
                            </div>
                            ...
                            <div class="btn-box"><a href="#" class="theme-btn btn-style-one"><span class="btn-title"> Our Services </span></a></div>
            ...
            <div class="auto-container">
                ...
                <div class="row">
                    ...
                    <div class="news-block-one col-lg-4 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                        <div class="inner-box">
                            <div class="image">
                                <a href="#"><img class="lazy-image owl-lazy" src="assets/images/resource/image-spacer-for-validation.png" data-src="assets/images/resource/news-1.jpg" alt=""></a>
                            </div>
                    ...
                    <div class="news-block-one col-lg-4 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                        <div class="inner-box">
                            <div class="image">
                                <a href="#"><img class="lazy-image owl-lazy" src="assets/images/resource/image-spacer-for-validation.png" data-src="assets/images/resource/news-2.jpg" alt=""></a>
                            </div>
                            <div class="lower-content">
                                <div class="category">Business</div>
                                <ul class="post-meta">
                    ...
                    <div class="news-block-one col-lg-4 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                        <div class="inner-box">
                            <div class="image">
                                <a href="#"><img class="lazy-image owl-lazy" src="assets/images/resource/image-spacer-for-validation.png" data-src="assets/images/resource/news-3.jpg" alt=""></a>
                            </div>
                            <div class="lower-content">
                                <div class="category">Business</div>
                                <ul class="post-meta">
        ...
        <section class="cta-section">
            <div class="auto-container">
                <div class="wrapper-box" style="background-image: url(assets/images/background/image-10.jpg);">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
...
<!-- Mirrored from azim.commonsupport.com/Finandox/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 04 Apr 2021 15:12:24 GMT -->
