...
<!-- Mirrored from azim.commonsupport.com/Finandox/rtl-home.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 04 Apr 2021 15:13:19 GMT -->
<head>
<meta charset="utf-8">
        ...
        <div class="header-top">
            <div class="auto-container">
				<div class="inner">
                    ...
                    <div class="top-right">
                        <a href="#" class="theme-btn btn-style-two"><span class="btn-title">إقتبس   </span></a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="dropdown"><a href="#">صفحات  </a>
                                        <ul>
                                            ...
                                            <li class="dropdown"><a href="shop.html">متجر </a>
                                                <ul>
                                                    <li><a href="shop.html">منتجات  </a></li>
                                                    <li><a href="product-details.html">تفاصيل المنتج  </a></li>
                                                    <li><a href="shopping-cart.html">عربة التسوق  </a></li>
                                    ...
                                    <li class="dropdown"><a href="#">أخبار</a>
                                        <ul>
                                            ...
                                            <li><a href="blog-standard.html">المدونة القياسية </a></li>
                                            <li><a href="blog-details.html">تفاصيل المدونة  </a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown"><a href="#">محفظة  </a>
                                        <ul>
                                            <li><a href="portfolio-1.html">محفظة واحدة  </a></li>
                                            <li><a href="portfolio-2.html">محفظة اثنين  </a></li>
                                            <li><a href="portfolio-details.html">تفاصيل المحفظة  </a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown"><a href="#">خدمات  </a>
                                        <ul>
                                            <li><a href="services-1.html">خدمات واحد  </a></li>
                                            <li><a href="services-2.html">خدمات اثنين  </a></li>
                                            <li><a href="services-details.html">تفاصيل الخدمات  </a></li>
                                        </ul>
                                    </li>
                                    <li><a href="about.html">معلومات عنا  </a></li>
                                    <li class="dropdown"><a href="index.html">الصفحة الرئيسية  </a>
                                        <ul>
                                            <li><a href="index.html">الصفحة الرئيسية 01 </a></li>
                                            <li><a href="index-2.html">الصفحة الرئيسية 02 </a></li>
                                            <li><a href="index-3.html">الصفحة الرئيسية 03 </a></li>
                                            <li><a href="index-4.html">الصفحة الرئيسية 04 </a></li>
                                            <li><a href="onepage.html">نسخة Onepage </a></li>
                                            <li><a href="rtl-home.html">RTL الرئيسية  </a></li>
			...
			<div class="slide-item">
				...
				<div class="auto-container">
					<div class="content-box">
						...
						<div class="btn-box"><a href="#" class="theme-btn btn-style-one"><span class="btn-title">-- خدماتنا  --</span></a><a href="#" class="theme-btn btn-style-two"><span class="btn-title">-- أعرف أكثر   --</span></a></div>
					</div>
				</div>
			</div>
                ...
                <div class="row m-0">
                    ...
                    <div class="welcome-block-one col-lg-4 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                        <div class="inner-box">
                            ...
                            <div class="read-more"><a href="#">اقرأ أكثر  </a></div>
                        </div>
                    </div>
                    <!-- Welcome Block One -->
                    <div class="welcome-block-one col-lg-4 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1200ms">
                    ...
                    <div class="col-lg-3 col-md-6 gallery-block-one all">
                        <div class="inner-box">
                            ...
                            <div class="caption-title">
                                <h5>المالية  </h5>
                                <h3><a href="#">ميراندا هيليكس بار  </a></h3>
                ...
                <div class="col-lg-6">
                    <div class="content-box">
                        ...
                        <ul class="nav nav-tabs tab-btn-style-one" role="tablist">
                            <li class="nav-item"><a class="nav-link active" id="tab-one-area" data-toggle="tab" href="#tab-one" role="tab" aria-controls="tab-one" aria-selected="true">مهمتنا  </a>
                            </li>
                            <li class="nav-item"><a class="nav-link" id="tab-two-area" data-toggle="tab" href="#tab-two" role="tab" aria-controls="tab-two" aria-selected="false">رؤيتنا  </a>
                            </li>
                            <li class="nav-item"><a class="nav-link" id="tab-three-area" data-toggle="tab" href="#tab-three" role="tab" aria-controls="tab-three" aria-selected="false">رؤيتنا  </a>
                            </li>
                        </ul>
                    ...
                    <div class="inner-box">
                        ...
                        <div class="lower-content">
                            ...
                            <ul class="post-meta">
                                ...
                                <li><a href="#"><i class="far fa-user"></i>بواسطة الادارية  </a></li>
                            </ul>
                            <h3><a href="blog-details.html">هو أفضل حل لعملك التجاري وجعل الضوضاء. </a></h3>
                            <div class="text">كتنا هي واحدة من الشركات الرائدة في العالم في مجال الاستشارات الإدارية. الحصول على اتصال هنا في اسرع وقت ممكن. </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="inner-box">
                        ...
                        <div class="lower-content">
                            ...
                            <ul class="post-meta">
                                ...
                                <li><a href="#"><i class="far fa-user"></i>واسطة الادارية </a></li>
                            </ul>
                            <h3><a href="blog-details.html">هو أفضل حل لعملك التجاري وجعل الضوضاء. </a></h3>
                            <div class="text">كتنا هي واحدة من الشركات الرائدة في العالم في مجال الاستشارات الإدارية. الحصول على اتصال هنا في اسرع وقت ممكن. </div>
                        </div>
        ...
        <div class="auto-container">
            ...
            <div class="award-image">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4">
                        <div class="image wow zoomIn" data-wow-delay="200ms" data-wow-duration="1200ms"><img src="assets/images/resource/award-5.png" alt=""></div>
                    </div>
    ...
    <footer class="main-footer">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <ul>
                                            ...
                                            <li><a href="#">خبر صحفى  </a></li>
                                            <li><a href="#">دراسة الحالة</a></li>
                                            <li><a href="#">شروط  </a></li>
                                        </ul>
                                    </div>
                                </div>
		...
		<div class="auto-container">				
            <div class="footer-bottom">
            	<div class="copyright">حقوق الطبع ل  <a href="#">Template_path</a> - 2020</div>
			</div>
		</div>
	</footer>
